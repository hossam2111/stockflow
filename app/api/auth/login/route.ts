...
export async function POST(request:Request){
  ...
  const selectedOrganization=selectedOrganizationId?await query<{name:string}>("SELECT name FROM organizations WHERE id=$1",[selectedOrganizationId]):null;
